...
<section id="location-mark">
    <div class="container">
        <div class="row">
            <div class="col-sm-4 d-flex text-center">
                <div class="d-flex flex-column field wow fadeInUp">
                    <div class="field-icon">
                        <h5>
                            <i class="fas fa-map-marker-alt"></i><span>කළුතර </span>
                        </h5>
                    </div>

                    <p></p>
                    <p class="mb-3"> රෝයල්වේ</p>
                    <p class="mb-3"> </p>
                    <p style="color: #c5bbb9; font-size: 0.7em;">072 320 6888 / 072 310 9776</p>
                </div>
            </div>
            <div class="col-sm-4 d-flex  text-center">
                <div class="d-flex flex-column field wow fadeInUp">
                    <div class="field-icon">
                        <h5><i class="fas fa-map-marker-alt"></i><span>ගම්පහ </span></h5>
                    </div>

                    <p></p>
                    <p class="mb-3"> සිප්සර </p>
                    <p class="mb-3"> </p>
                    <p style="color: #c5bbb9; font-size: 0.7em;">072 320 6888 / 072 310 9776</p>
                </div>
            </div>
            <div class="col-sm-4 d-flex  text-center">
                <div class="d-flex flex-column field wow fadeInUp">
                    <div class="field-icon">
                        <h5><i class="fas fa-map-marker-alt"></i><span>බොරැල්ල </span></h5>
                    </div>

                    <p></p>
                    <p class="mb-3"> තිලකරත්නාරාමය </p>
                    <p class="mb-3"> </p>
                    <p style="color: #c5bbb9; font-size: 0.7em;">072 320 6888 / 072 310 9776</p>
                </div>
            </div>
